...
export const CreateEnvironment = createInsertSchema(
...
export const UpdateEnvironment = createUpdateSchema(
  schema.environmentsTable,
).omit(defaultOmit);
...
export const CreateApiKeyBinding = createInsertSchema(
  schema.apiKeyBindingsTable,
).omit(defaultOmit);
...
export const UpdateApiKeyBinding = createUpdateSchema(
  schema.apiKeyBindingsTable,
).omit(defaultOmit);
...
export const CreateProvider = createInsertSchema(schema.providersTable).omit(
  defaultOmit,
);
export type CreateProvider = z.infer<typeof CreateProvider>;
export type CreateProviderInput = z.input<typeof CreateProvider>;
export const UpdateProvider = createUpdateSchema(schema.providersTable).omit(
  defaultOmit,
);
...
export const CreateModel = createInsertSchema(schema.modelsTable).omit(
  defaultOmit,
);
export type CreateModel = z.infer<typeof CreateModel>;
export type CreateModelInput = z.input<typeof CreateModel>;
export const UpdateModel = createUpdateSchema(schema.modelsTable).omit(
  defaultOmit,
);
...
export const CreateProviderModel = createInsertSchema(
  schema.providerModelsTable,
).omit(defaultOmit);
...
export const UpdateProviderModel = createUpdateSchema(
  schema.providerModelsTable,
).omit(defaultOmit);
...
export const CreatePrice = createInsertSchema(schema.priceBookTable).omit(
  defaultOmit,
);
export type CreatePrice = z.infer<typeof CreatePrice>;
export type CreatePriceInput = z.input<typeof CreatePrice>;
export const UpdatePrice = createUpdateSchema(schema.priceBookTable).omit(
  defaultOmit,
);
export type UpdatePrice = z.infer<typeof UpdatePrice>;
export type UpdatePriceInput = z.input<typeof UpdatePrice>;

export const ProviderCredential = createSelectSchema(
  schema.providerCredentialsTable,
);
export type ProviderCredential = z.infer<typeof ProviderCredential>;
export const CreateProviderCredential = createInsertSchema(
  schema.providerCredentialsTable,
).omit(defaultOmit);
export type CreateProviderCredential = z.infer<typeof CreateProviderCredential>;
export type CreateProviderCredentialInput = z.input<
  typeof CreateProviderCredential
>;
export const UpdateProviderCredential = createUpdateSchema(
  schema.providerCredentialsTable,
).omit(defaultOmit);
export type UpdateProviderCredential = z.infer<typeof UpdateProviderCredential>;
export type UpdateProviderCredentialInput = z.input<
  typeof UpdateProviderCredential
>;

export const ModelAlias = createSelectSchema(schema.modelAliasesTable);
export type ModelAlias = z.infer<typeof ModelAlias>;
export const CreateModelAlias = createInsertSchema(
  schema.modelAliasesTable,
).omit(defaultOmit);
...
export const UpdateModelAlias = createUpdateSchema(
  schema.modelAliasesTable,
).omit(defaultOmit);
...
export const CreateRoutingPolicy = createInsertSchema(
  schema.routingPoliciesTable,
).omit(defaultOmit);
...
export const UpdateRoutingPolicy = createUpdateSchema(
  schema.routingPoliciesTable,
).omit(defaultOmit);
...
export const CreateRoutingRule = createInsertSchema(
  schema.routingRulesTable,
).omit(defaultOmit);
...
export const UpdateRoutingRule = createUpdateSchema(
  schema.routingRulesTable,
).omit(defaultOmit);
...
export const CreateRoutingTarget = createInsertSchema(
  schema.routingTargetsTable,
).omit(defaultOmit);
...
export const UpdateRoutingTarget = createUpdateSchema(
  schema.routingTargetsTable,
).omit(defaultOmit);
...
export const CreateRequest = createInsertSchema(schema.requestsTable).omit(
  defaultOmit,
);
export type CreateRequest = z.infer<typeof CreateRequest>;
export type CreateRequestInput = z.input<typeof CreateRequest>;
export const UpdateRequest = createUpdateSchema(schema.requestsTable).omit(
  defaultOmit,
);
...
export const CreateMessage = createInsertSchema(schema.messagesTable).omit(
  defaultOmit,
);
export type CreateMessage = z.infer<typeof CreateMessage>;
export type CreateMessageInput = z.input<typeof CreateMessage>;
export const UpdateMessage = createUpdateSchema(schema.messagesTable).omit(
  defaultOmit,
);
...
export const CreateResponse = createInsertSchema(schema.responsesTable).omit(
  defaultOmit,
);
export type CreateResponse = z.infer<typeof CreateResponse>;
export type CreateResponseInput = z.input<typeof CreateResponse>;
export const UpdateResponse = createUpdateSchema(schema.responsesTable).omit(
  defaultOmit,
);
...
export const CreateUsageEvent = createInsertSchema(
  schema.usageEventsTable,
).omit(defaultOmit);
...
export const UpdateUsageEvent = createUpdateSchema(
  schema.usageEventsTable,
).omit(defaultOmit);
...
export const CreateQuota = createInsertSchema(schema.quotasTable).omit(
  defaultOmit,
);
export type CreateQuota = z.infer<typeof CreateQuota>;
export type CreateQuotaInput = z.input<typeof CreateQuota>;
export const UpdateQuota = createUpdateSchema(schema.quotasTable).omit(
  defaultOmit,
);
...
export const CreateWebhookEndpoint = createInsertSchema(
  schema.webhookEndpointsTable,
).omit(defaultOmit);
...
export const UpdateWebhookEndpoint = createUpdateSchema(
  schema.webhookEndpointsTable,
).omit(defaultOmit);
...
export const WebhookDelivery = createSelectSchema(
  schema.webhookDeliveriesTable,
);
export type WebhookDelivery = z.infer<typeof WebhookDelivery>;
export const CreateWebhookDelivery = createInsertSchema(
  schema.webhookDeliveriesTable,
).omit(defaultOmit);
...
export const UpdateWebhookDelivery = createUpdateSchema(
  schema.webhookDeliveriesTable,
).omit(defaultOmit);
...
export const CreateAuditLog = createInsertSchema(schema.auditLogsTable).omit(
  defaultOmit,
);
export type CreateAuditLog = z.infer<typeof CreateAuditLog>;
export type CreateAuditLogInput = z.input<typeof CreateAuditLog>;
export const UpdateAuditLog = createUpdateSchema(schema.auditLogsTable).omit(
  defaultOmit,
);
